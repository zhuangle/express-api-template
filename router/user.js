...
router.post(
  "/verifyCaptcha",
  userValidator.verifyCaptcha,
  userCtl.verifyCaptcha
);
...
router.put(
  "/updateUserDept",
  auth,
  userValidator.updateUserDept,
  userCtl.updateUserDept
);
// 更新用户信息
router.put(
  "/updateUserProfile",
...
router.put(
  "/updateUserStatus",
  userValidator.registerStatus,
  auth,
  userCtl.updateUserStatus
);
// 用户修改密码
router.put(
  "/changePassword",
