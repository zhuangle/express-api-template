...
module.exports = (sequelize, DataTypes) => {
  ...
  /* 
     ...
     perm_user_perm  # 用户与权限对应关系表    
     perm_dept_role  # 机构与角色对应关系表
     perm_dept_perm  # 机构与权限对应关系表 
  ...
  */
  ...
  // perm_user_perm  # 用户与权限对应关系表 
  const PermUserPerm = sequelize.define('perm_user_perm', {
    uid: {
      type: DataTypes.UUID,
      required: true
    },
  ...
  //   perm_dept_role  # 机构与角色对应关系表
  const PermDeptRole = sequelize.define('perm_dept_role', {
    uid: {
      type: DataTypes.UUID,
      required: true
    },
  ...
  // perm_dept_perm  # 机构与权限对应关系表 
  const PermDeptPerm = sequelize.define('perm_dept_perm', {
    deptId: {
      type: DataTypes.UUID,
      required: true
    },
